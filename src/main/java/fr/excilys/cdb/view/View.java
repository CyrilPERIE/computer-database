...
//			}finally {break;}
	...
	public int getUpdateChoice() {
		System.out.println("What do you want to update ? (" + UPDATE_MANUFACTURER_NAME + "," + UPDATE_COMPUTER_NAME
				+ "," + UPDATE_INTRODUCED_DATE + "," + UPDATE_DISCONTINUED_DATE + ")");
		return scannerNextInt();
	}
